        ...
        >
          ...
          {success ? (
            ...
            >
              ...
              <h2 className="font-display text-xl font-bold text-saas-text mb-2">Check your email</h2>
              <p className="text-saas-subtext text-sm mb-6">
                We&apos;ve sent a confirmation link to{" "}
                <strong className="text-saas-text">{email}</strong>.
                Click it to activate your account.
              </p>
              <Link
                href="/login"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-saas-primary text-white text-sm font-semibold hover:shadow-saas-glow transition-all duration-200"
              >
            ...
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-saas-border bg-white text-saas-text text-sm font-semibold hover:bg-slate-50 hover:border-saas-primary/30 transition-all duration-200 shadow-saas-sm mb-6 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {isGoogleLoading ? (
                  <Loader2 className="w-4 h-4 animate-spin text-saas-subtext" />
                ) : (
